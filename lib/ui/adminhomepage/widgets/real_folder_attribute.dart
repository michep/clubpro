...
class RealCatalogFolderAttribute extends CatalogFolderAttribute {
  const RealCatalogFolderAttribute({
  ...
  @override
  State<RealCatalogFolderAttribute> createState() => _IntCatalogFolderAttributeState();
}

class _IntCatalogFolderAttributeState extends CatalogFolderAttributeState<RealCatalogFolderAttribute, RealAttributeTemplate> {
  @override
  Widget content() {
    return Expanded(
      child: Column(
